#python replace-mask-video.py <full path to GIF with filename+extention> <full path to user video filename+extention> <full path to mask filename+extention> <name of output file+extension>
import sys
import cv2
import time
import numpy as np
